...
bbb.mhdgeo=0 #-set cylindrical geometry
#bbb.isfixlb=2 #left boundary as sym. plane; no flux at cut

com.isgrdsym=1 #-make the grid symmetric in z

grd.rad0 =1.0       #-location of 'radial' separ'x for cylinder or slab
grd.radx = grd.rad0 + 4.e-2    #-outer "radial" wall
grd.radm = grd.rad0 - 2.e-2    #-minimum "radial" position

grd.za0 = 0.    #-poloidal symmetry plane location
grd.zax=1.0     #-poloidal location of divertor plate   
grd.zaxpt=0.5   #-poloidal location of x-point
grd.alfyt=-0.1  #-radial nonuniformity factor; < 0 => expanding
grd.alfxt= 0.1  #poliodal nonuniformity factor; to make smooth
